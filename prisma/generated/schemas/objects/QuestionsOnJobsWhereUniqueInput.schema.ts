...
import { QuestionsOnJobsJobIdQuestionIdCompoundUniqueInputObjectSchema } from './QuestionsOnJobsJobIdQuestionIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  jobId_questionId: z.lazy(() => QuestionsOnJobsJobIdQuestionIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const present = (k: string) => (obj as any)[k] != null;
        const singles: string[] = [] as string[];
        const groups: string[][] = [["jobId","questionId"]] as string[][];
...
export const QuestionsOnJobsWhereUniqueInputObjectSchema: z.ZodType<Prisma.QuestionsOnJobsWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.QuestionsOnJobsWhereUniqueInput>;
export const QuestionsOnJobsWhereUniqueInputObjectZodSchema = makeSchema();
