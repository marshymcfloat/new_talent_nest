...
export const JobFindUniqueOrThrowSchema = z.object({ select: JobSelectObjectSchema.optional(), include: JobIncludeObjectSchema.optional(), where: JobWhereUniqueInputObjectSchema })