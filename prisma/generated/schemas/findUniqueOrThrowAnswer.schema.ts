...
export const AnswerFindUniqueOrThrowSchema = z.object({ select: AnswerSelectObjectSchema.optional(), include: AnswerIncludeObjectSchema.optional(), where: AnswerWhereUniqueInputObjectSchema })