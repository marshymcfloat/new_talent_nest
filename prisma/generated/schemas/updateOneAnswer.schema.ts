...
export const AnswerUpdateOneSchema = z.object({ select: AnswerSelectObjectSchema.optional(), include: AnswerIncludeObjectSchema.optional(), data: z.union([AnswerUpdateInputObjectSchema, AnswerUncheckedUpdateInputObjectSchema]), where: AnswerWhereUniqueInputObjectSchema  })