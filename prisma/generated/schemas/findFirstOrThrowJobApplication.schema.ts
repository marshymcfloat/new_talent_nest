...
export const JobApplicationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.JobApplicationSelect> = z.object({
...
export const JobApplicationFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    jobId: z.boolean().optional(),
    resumeId: z.boolean().optional(),
