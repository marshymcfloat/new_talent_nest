...
export const EducationFindUniqueSchema = z.object({ select: EducationSelectObjectSchema.optional(), include: EducationIncludeObjectSchema.optional(), where: EducationWhereUniqueInputObjectSchema })