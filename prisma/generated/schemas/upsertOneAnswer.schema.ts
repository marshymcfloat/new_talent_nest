...
export const AnswerUpsertSchema = z.object({ select: AnswerSelectObjectSchema.optional(), include: AnswerIncludeObjectSchema.optional(), where: AnswerWhereUniqueInputObjectSchema, create: z.union([ AnswerCreateInputObjectSchema, AnswerUncheckedCreateInputObjectSchema ]), update: z.union([ AnswerUpdateInputObjectSchema, AnswerUncheckedUpdateInputObjectSchema ])  })