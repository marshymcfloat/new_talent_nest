...
export const QuestionsOnJobsDeleteOneSchema = z.object({ select: QuestionsOnJobsSelectObjectSchema.optional(), include: QuestionsOnJobsIncludeObjectSchema.optional(), where: QuestionsOnJobsWhereUniqueInputObjectSchema  })