...
export const SkillUpdateOneSchema = z.object({ select: SkillSelectObjectSchema.optional(), include: SkillIncludeObjectSchema.optional(), data: z.union([SkillUpdateInputObjectSchema, SkillUncheckedUpdateInputObjectSchema]), where: SkillWhereUniqueInputObjectSchema  })