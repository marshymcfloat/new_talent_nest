...
export const EmployerQuestionFindUniqueOrThrowSchema = z.object({ select: EmployerQuestionSelectObjectSchema.optional(), include: EmployerQuestionIncludeObjectSchema.optional(), where: EmployerQuestionWhereUniqueInputObjectSchema })