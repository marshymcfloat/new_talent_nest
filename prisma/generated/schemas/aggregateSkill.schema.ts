...
export const SkillAggregateSchema = z.object({ orderBy: z.union([SkillOrderByWithRelationInputObjectSchema, SkillOrderByWithRelationInputObjectSchema.array()]).optional(), where: SkillWhereInputObjectSchema.optional(), cursor: SkillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), SkillCountAggregateInputObjectSchema ]).optional(), _min: SkillMinAggregateInputObjectSchema.optional(), _max: SkillMaxAggregateInputObjectSchema.optional(), _avg: SkillAvgAggregateInputObjectSchema.optional(), _sum: SkillSumAggregateInputObjectSchema.optional() })