...
export const EducationAggregateSchema = z.object({ orderBy: z.union([EducationOrderByWithRelationInputObjectSchema, EducationOrderByWithRelationInputObjectSchema.array()]).optional(), where: EducationWhereInputObjectSchema.optional(), cursor: EducationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), EducationCountAggregateInputObjectSchema ]).optional(), _min: EducationMinAggregateInputObjectSchema.optional(), _max: EducationMaxAggregateInputObjectSchema.optional() })