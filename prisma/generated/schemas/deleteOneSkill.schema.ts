...
export const SkillDeleteOneSchema = z.object({ select: SkillSelectObjectSchema.optional(), include: SkillIncludeObjectSchema.optional(), where: SkillWhereUniqueInputObjectSchema  })