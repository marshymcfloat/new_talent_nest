...
export const LicenceAndCertificateFindUniqueSchema = z.object({ select: LicenceAndCertificateSelectObjectSchema.optional(),  where: LicenceAndCertificateWhereUniqueInputObjectSchema })