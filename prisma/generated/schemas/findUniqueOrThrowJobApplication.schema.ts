...
export const JobApplicationFindUniqueOrThrowSchema = z.object({ select: JobApplicationSelectObjectSchema.optional(), include: JobApplicationIncludeObjectSchema.optional(), where: JobApplicationWhereUniqueInputObjectSchema })