...
export const JobApplicationFindUniqueSchema = z.object({ select: JobApplicationSelectObjectSchema.optional(), include: JobApplicationIncludeObjectSchema.optional(), where: JobApplicationWhereUniqueInputObjectSchema })