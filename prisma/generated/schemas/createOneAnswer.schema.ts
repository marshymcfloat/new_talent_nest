...
export const AnswerCreateOneSchema = z.object({ select: AnswerSelectObjectSchema.optional(), include: AnswerIncludeObjectSchema.optional(), data: z.union([AnswerCreateInputObjectSchema, AnswerUncheckedCreateInputObjectSchema])  })