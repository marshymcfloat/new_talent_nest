...
export const CompanyMemberFindUniqueOrThrowSchema = z.object({ select: CompanyMemberSelectObjectSchema.optional(), include: CompanyMemberIncludeObjectSchema.optional(), where: CompanyMemberWhereUniqueInputObjectSchema })