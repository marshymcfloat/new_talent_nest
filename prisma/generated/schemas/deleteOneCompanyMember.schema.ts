...
export const CompanyMemberDeleteOneSchema = z.object({ select: CompanyMemberSelectObjectSchema.optional(), include: CompanyMemberIncludeObjectSchema.optional(), where: CompanyMemberWhereUniqueInputObjectSchema  })