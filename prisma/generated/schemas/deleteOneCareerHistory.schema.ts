...
export const CareerHistoryDeleteOneSchema = z.object({ select: CareerHistorySelectObjectSchema.optional(), include: CareerHistoryIncludeObjectSchema.optional(), where: CareerHistoryWhereUniqueInputObjectSchema  })