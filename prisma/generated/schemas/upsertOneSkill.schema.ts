...
export const SkillUpsertSchema = z.object({ select: SkillSelectObjectSchema.optional(), include: SkillIncludeObjectSchema.optional(), where: SkillWhereUniqueInputObjectSchema, create: z.union([ SkillCreateInputObjectSchema, SkillUncheckedCreateInputObjectSchema ]), update: z.union([ SkillUpdateInputObjectSchema, SkillUncheckedUpdateInputObjectSchema ])  })