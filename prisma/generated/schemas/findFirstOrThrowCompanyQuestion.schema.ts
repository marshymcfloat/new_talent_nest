...
export const CompanyQuestionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CompanyQuestionSelect> = z.object({
...
export const CompanyQuestionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    text: z.boolean().optional(),
    type: z.boolean().optional(),
    options: z.boolean().optional(),
...
export const CompanyQuestionFindFirstOrThrowSchema: z.ZodType<Prisma.CompanyQuestionFindFirstOrThrowArgs> = z.object({ select: CompanyQuestionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CompanyQuestionIncludeObjectSchema.optional()), orderBy: z.union([CompanyQuestionOrderByWithRelationInputObjectSchema, CompanyQuestionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CompanyQuestionWhereInputObjectSchema.optional(), cursor: CompanyQuestionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CompanyQuestionScalarFieldEnumSchema, CompanyQuestionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CompanyQuestionFindFirstOrThrowArgs>;

export const CompanyQuestionFindFirstOrThrowZodSchema = z.object({ select: CompanyQuestionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CompanyQuestionIncludeObjectSchema.optional()), orderBy: z.union([CompanyQuestionOrderByWithRelationInputObjectSchema, CompanyQuestionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CompanyQuestionWhereInputObjectSchema.optional(), cursor: CompanyQuestionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CompanyQuestionScalarFieldEnumSchema, CompanyQuestionScalarFieldEnumSchema.array()]).optional() }).strict();