...
export const CompanyQuestionFindUniqueOrThrowSchema = z.object({ select: CompanyQuestionSelectObjectSchema.optional(), include: CompanyQuestionIncludeObjectSchema.optional(), where: CompanyQuestionWhereUniqueInputObjectSchema })