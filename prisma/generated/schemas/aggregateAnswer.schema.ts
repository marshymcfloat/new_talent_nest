...
export const AnswerAggregateSchema = z.object({ orderBy: z.union([AnswerOrderByWithRelationInputObjectSchema, AnswerOrderByWithRelationInputObjectSchema.array()]).optional(), where: AnswerWhereInputObjectSchema.optional(), cursor: AnswerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), AnswerCountAggregateInputObjectSchema ]).optional(), _min: AnswerMinAggregateInputObjectSchema.optional(), _max: AnswerMaxAggregateInputObjectSchema.optional() })