...
export const EducationFindUniqueOrThrowSchema = z.object({ select: EducationSelectObjectSchema.optional(), include: EducationIncludeObjectSchema.optional(), where: EducationWhereUniqueInputObjectSchema })