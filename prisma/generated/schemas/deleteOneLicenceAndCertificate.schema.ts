...
export const LicenceAndCertificateDeleteOneSchema = z.object({ select: LicenceAndCertificateSelectObjectSchema.optional(),  where: LicenceAndCertificateWhereUniqueInputObjectSchema  })